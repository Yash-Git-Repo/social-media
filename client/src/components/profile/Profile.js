      ...
      <div className="container">
        ...
        <div className="right-part">
          <div className="profile-card">
            ...
            {isMyProfile ? (
              <button className='update btn-secondary' onClick={() => navigate('/updateProfile')}>Update</button>
            ) : (
              <button className='follow btn-primary' onClick={handleUserFollow}>{isFollowing ? 'Unfollow' : 'Follow'}</button>
            )}
